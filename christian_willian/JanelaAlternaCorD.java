...
public class JanelaAlternaCorD implements GLEventListener {
	private GL4 gl;
	...
	public static void main(String[] args) {
		...
		glWindow.addGLEventListener(new JanelaAlternaCorD());
	...
	public void display(GLAutoDrawable drawable) {
		...
		if (g >= 1.0 && incremento_green == incremento && incremento_red == 0.0f && incremento_blue == 0.0f) {
